...
export default function Contact() {
  ...
  useEffect(() => {
    if (data?.data?.contact?.location) {
      const encodedLocation = encodeURIComponent(data.data.contact.location);
      setMapSrc(`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.277552998015!2d90.3678744!3d23.773128800000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c0ae4adf3cb9%3A0x7f2cf443b764e4a5!2s${encodedLocation}!5e0!3m2!1sen!2sbd!4v1718281880960!5m2!1sen!2sbd`);
    }
  }, [data]);
  ...
  return (
    <div className="">
      ...
      <CustomBanner title={"CONTACT US"} backgroundImage='/images/banner.jpg' breadcrumbs={[{ label: "Home", href: "/" }, { label: "Contact Us", href: "/contact" }]} />
