    ...
    return (
        <div className="">
                    ...
                    <div className="bg-[#F1F7F4] rounded-xl p-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-700">15 Soloki St, Surulere, Lagos</p>
                                <p className="text-gray-700">101241, Lagos, Nigeria</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#F1F7F4] rounded-xl p-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-700">+234 912 230 8240</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#F1F7F4] rounded-xl p-6">
                        <div className="flex items-start">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-gray-700">info@theluxauto.com</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="my-12 md:my-24 rounded-lg overflow-hidden border border-gray-200">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63427.97620249539!2d3.3288253771179342!3d6.5076982108365325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8c0f7e31d467%3A0xd2fc0a14415d1098!2sSurulere%2C%20Lagos%2C%20Nigeria!5e0!3m2!1sen!2sus!4v1681234567890!5m2!1sen!2sus"
                    width="100%"
                    height="400"
                    style={{ border: 0 }}
                    allowFullScreen=""
